...
// build/dev/javascript/core/core/greeting.mjs
...
function view(model) {
  return div(toList([
    ...
    h1(toList([class$("text-4xl font-bold text-gray-900")]), toList([text2(model.message)]))
  ]));
}
function main() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError("let_assert", FILEPATH, "ui", 9, "main", "Pattern match failed, no pattern matched the value.", { value: $, start: 214, end: 263, pattern_start: 225, pattern_end: 230 });
  }
  return;
}
